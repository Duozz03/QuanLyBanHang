      ...
      <div className="modal-content">
        ...
        <div className="px-4 pt-0">
          <ul className="nav nav-tabs custom-tabs" role="tablist">
            <li className="nav-item" role="presentation">
              <button className="nav-link active" data-bs-toggle="tab" type="button" role="tab">Thông tin</button>
            </li>
          </ul>
        </div>
        ...
        <form onSubmit={handleSave}>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-12">
                    ...
                    <div className="d-flex gap-2">
                      <select className="form-select flex-grow-1" name="category" value={form.category} onChange={handleChange}>
                        <option value="">Chọn nhóm hàng (Bắt buộc)</option>
                        {/* bạn có thể map options ở đây */}
                      </select>
                      <button type="button" className="btn btn-link small">Tạo mới</button>
                  ...
                  <div className="col-12">
                    <div className="card section-card">
                      <div className="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" className="btn btn-sm btn-link">Thiết lập giá</button>
                      </div>
                      <div className="card-body">
                        <div className="row g-3">
                          <div className="col-md-6">
                            <label className="form-label">Giá vốn</label>
                            <input type="number" className="form-control" name="importPrice" value={form.importPrice} onChange={handleChange} />
                          </div>
                          <div className="col-md-6">
              ...
              <div className="col-lg-4">
                <div className="image-uploader">
                  ...
                  <div className="mt-3 d-grid">
                    ...
                    <label htmlFor="fileInput" className="btn btn-outline-secondary">Chọn ảnh</label>
                  </div>
          ...
          <div className="modal-footer d-flex justify-content-between px-4">
            <div>
              <button type="button" className="btn btn-outline-secondary me-2" onClick={onClose}>Bỏ qua</button>
            </div>

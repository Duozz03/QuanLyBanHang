...
public enum ErrorCode {
    ...
    CATEGORY_NOT_EXISTED(1020, "Category not existed", HttpStatus.NOT_FOUND),
    USERNAME_INVALID(1003, "Username must be at least 4 to 20 characters", HttpStatus.BAD_REQUEST),
    PASSWORD_INVALID(1004, "Password must be at least 6 to 20 characters", HttpStatus.BAD_REQUEST),
    ...
    INVALID_CREDENTIALS(1008, "Password failed", HttpStatus.UNAUTHORIZED),
    ...
    EMAIL_ALREADY_EXISTS(1020,"Email already exists" ,HttpStatus.BAD_REQUEST),
    OLD_PASSWORD_REQUIRED(400,"Old password is required" , HttpStatus.BAD_REQUEST),
    ...
    STATUS_REQUIRED(2006, "Status is required", HttpStatus.BAD_REQUEST),
    CATEGORY_REQUIRED(2007, "Category is required", HttpStatus.BAD_REQUEST),
    CATEGORY_NAME_NOT_BLANK(2008, "Category name must not be blank", HttpStatus.BAD_REQUEST),
    USERNAME_EMPTY(2009, "Username must not be blank", HttpStatus.BAD_REQUEST),
    PASSWORD_EMPTY(2010, "Password must not be blank", HttpStatus.BAD_REQUEST),
    FULLNAME_REQUIRED(2013, "Full name is required", HttpStatus.BAD_REQUEST),
    FULLNAME_INVALID(2014, "Full name must not exceed 100 characters", HttpStatus.BAD_REQUEST),
    SDT_INVALID(2015, "SDT must not exceed 15 characters", HttpStatus.BAD_REQUEST),
    ROLE_REQUIRED(2016, "Role is required", HttpStatus.BAD_REQUEST),
    EMAIL_INVALID(2017, "Email is invalid", HttpStatus.BAD_REQUEST),
    ;
